...
function getAngleBetweenVectors(x1, y1, x2, y2) {
   /* var multiple = x2*x1+y1*y2;
    var point1 = Math.sqrt(x1*x1+y1*y1);
    var point2 = Math.sqrt(x2*x2+y2*y2);
    var anglerad = (multiple/point1*point2)*180/Math.PI;
    return anglerad;*/
